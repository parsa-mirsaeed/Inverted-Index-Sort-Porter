        ...
        <div className="min-h-screen font-sans selection:bg-accent selection:text-white bg-[#0f1012] overflow-x-hidden">
            ...
            <section className="py-20 px-6 max-w-5xl mx-auto relative">
                ...
                <div className="prose prose-invert prose-lg text-academic-300 max-w-none pl-8">
                    ...
                    <p className="mt-4 text-academic-300">
                        The course lectures and additional materials are available at <a href="https://tadrisonline.com/IR/" className="text-accent hover:underline" target="_blank" rel="noopener noreferrer">tadrisonline.com/IR/</a>.
                    </p>
            ...
            <footer className="border-t border-academic-800 bg-black py-16 px-6">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex gap-4">
                        <a href="https://github.com/parsa-mirsaeed" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-academic-900 flex items-center justify-center text-academic-500 hover:text-white hover:bg-accent transition-all">
                            <Github size={20} />
                        </a>
                        <a href="https://github.com/parsa-mirsaeed/Inverted-Index-Sort-Porter/raw/main/Core/main.pdf" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-academic-900 flex items-center justify-center text-academic-500 hover:text-white hover:bg-accent transition-all" title="View PDF Report">
                            <FileText size={20} />
                        </a>
                    </div>
                </div>
